       ...
       Future<void> signUp({
        ...
        try {
          ...
          if (user != null && !user.emailVerified) {
            ...
            if (context.mounted) {
              String lastName = name.split(' ').isNotEmpty ? name.split(' ').last : "";
    ...
    static  Future<void> sendVerificationEmail(BuildContext context) async {
      ...
      Future<void> loginWithGoogle(BuildContext context) async {
        try {
          ...
          if (googleUser == null) {
            if (context.mounted) {
              CustomSnackbar.show(context: context, label: "Sign-in canceled. Please try again.");
            }
            return;
          }
          ...
          if (googleAuth.idToken == null || googleAuth.accessToken == null) {
            if (context.mounted) {
              CustomSnackbar.show(context: context, label: "Authentication failed. Please try again.");
            }
            return;
          }
          ...
          if (context.mounted) {
            String lastName = userCredential.user?.displayName?.split(' ').last ?? "";
            CustomAlertBox().showCustomAnimatedAlert(
              context: context,
